...
describe('getMinAndMaxFromJson', () => {
  ...
  it('should return the minimum and maximum values of a nested property when the JSON array is not empty', () => {
    const json = [
      { id: 1, value: { nested: 5 } },
      { id: 2, value: { nested: 10 } },
      { id: 3, value: { nested: 3 } },
      { id: 4, value: { nested: 8 } },
    ];

    const result = getMinAndMaxFromJson({
      json,
      property: 'value',
      subProperty: 'nested' as unknown as undefined,
    });
